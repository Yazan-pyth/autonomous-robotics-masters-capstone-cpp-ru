...
| Группа | Студентов | Ответственность | Классический метод | DL/RL-метод |
|---|---:|---|---|---|
| [G1](projects/01_localization.md) | 3 | Локализация и геометрическая карта | EKF + scan-to-map ICP, фиксированная модель шума | Та же схема с MLP для адаптивной ковариации измерений |
| [G2](projects/02_perception.md) | 2 | Восприятие и локальная карта препятствий | Геометрическая обработка RGB-D: плоскость пола, кластеры | Небольшая CNN сегментации проходимой области |
| [G3](projects/03_planning.md) | 2 | Глобальное планирование | A* с фиксированной стоимостью проходимости | A* с обученной CNN-картой стоимости |
| [G4](projects/04_control.md) | 3 | Локальное управление и независимый safety monitor | Ограниченный MPC | PPO-политика локального управления |
| [G5](projects/05_mission.md) | 2 | Диспетчеризация заявок и общая сборка | Behavior Tree + фиксированное правило выбора заявки | DQN для выбора следующей заявки внутри того же BT |
| **Всего** | **12** | | | |
...
1. Исходники C++17, CMake/ament, ROS 2 `rclcpp`, тесты и Git-история с review.
