...
Исследовательский вопрос: помогает ли адаптивная оценка шума сохранять точность и consistency при wheel slip и вырожденном scan matching?
...
Обязанности по реализации, проверке и интеграции распределяются внутри группы. Каждый review-ит другую часть и объясняет оба метода на защите.
